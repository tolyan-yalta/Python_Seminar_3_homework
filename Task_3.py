...
list_random = []
for i in range(N):
    list_random.append(round(random.uniform(0, 10), 2))
...
print(f'Разница между максимальным и минимальным значением дробной части элементов = {round(list_random[-1] - list_random[0], 2)}')
